      ...
      <div className="absolute right-0 top-0 w-[380px] h-screen overflow-auto bg-gray-300 bg-opacity-50">
        <div className="container flex flex-col items-center justify-center w-full mx-auto">
          <div className="w-full px-4 py-2 mb-2 bg-white border rounded-md shadow sm:px-6 ">
            ...
            <button className="absolute right-5 px-4 py-2 text-sm font-medium text-white bg-purple-600 border border-transparent rounded-md shadow-sm hover:bg-purple-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-500">
              닫기
            </button>
          ...
          <ul className="pl-0 flex flex-col w-full overflow-auto">
            <FriendsCard name="김승덕" isConnected={true} isInvited={true}></FriendsCard>
            <FriendsCard name="김승덕" isConnected={true} isInvited={true}></FriendsCard>
            <FriendsCard name="김승덕" isConnected={true} isInvited={true}></FriendsCard>
            <FriendsCard name="김승덕" isConnected={false} isInvited={true}></FriendsCard>
            <FriendsCard name="김승덕" isConnected={true} isInvited={true}></FriendsCard>
