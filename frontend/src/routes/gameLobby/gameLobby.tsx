      ...
      <div className="flex justify-evenly ">
        <div>
          <div className="image-container rounded-md border border-gray-400 grid grid-cols-2 overflow-auto mr-10">
            ...
            {imageList.map((image) => {
              return <ImageCard imageSrc={imageList}></ImageCard>;
            })}
          </div>
        </div>
